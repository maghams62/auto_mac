...
### next_track
**Description:** Skip to the next track in the queue or playlist.
**Parameters:** None

### previous_track
**Description:** Return to the previous track (Spotify restarts the current track if invoked twice quickly).
**Parameters:** None

### get_spotify_status
**Description:** Get current playback status, track title, and artist information from Spotify.
**Parameters:** None

### play_song
**Description:** Play a specific song on Spotify with semantic disambiguation support.
**Parameters:**
